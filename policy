...
This Policy is incorporated into, and is subject to, the myapp Terms of Service. Capitalized terms used but not defined in this Policy have the meaning given to them in the myapp Terms of Service.

1. Definitions
Client – a customer of myapp.

Client Data – the set of rights and privileges on the Web Site assigned to a User by a Client;

Client – personal data, reports, addresses, and other files, folders or documents in electronic form that a User of the Service stores within the Service.

Personal Data – means any information relating to an identified or identifiable natural person.

Public Area – the area of the Site that can be accessed both by Users and Visitors, without needing to use a login ID and a password.

Restricted Area – the area of the Site that can be accessed only by Users, and where access requires the use of a login ID and a password.
...
We collect different types of information from or through the Service. The legal bases for myapp’s processing of personal data are primarily that the processing is necessary for providing the Service in accordance with myapp’s Terms of Service and that the processing is carried out in myapp’s legitimate interests, which are further explained in the section “How We Use the Information We Collect” of this Policy. We may also process data upon your consent, asking for it as appropriate.
...
Improvements. We use the information – other than Client Data – to understand and analyze the usage trends and preferences of our Visitors and Users, to improve the Service, and to develop new products, services, feature, and functionality. Should this purpose require myapp to process Client Data, then the data will only be used in anonymized or aggregated form.
...
myapp has no direct relationship with the Client’s customers or third party whose Personal Data it may process on behalf of a Client. An individual who seeks access, or who seeks to correct, amend, delete inaccurate data or withdraw consent for further contact should direct his or her query to the Client or User they deal with directly. If the Client requests myapp to remove the data, we will respond to its request within thirty (30) days. We will delete, amend or block access to any Personal Data that we are storing only if we receive a written request to do so from the Client who is responsible for such Personal Data, unless we have a legal right to retain such Personal Data. We reserve the right to retain a copy of such data for archiving purposes, or to defend our rights in litigation. Any such request regarding Client Data should be addressed as indicated in the “How to Contact Us” section, and include sufficient information for myapp to identify the Client or its customer or third party and the information to delete or amend.
...
We work with a variety of third parties to attempt to understand the profiles of the individuals who are most likely to be interested in the myapp products or services so that we can send them promotional emails, or serve our advertisements to them on the websites and mobile apps of other entities.
...
billing information is retained for a period of 7 years as of their provision to myapp in accordance with the Estonian accounting and taxation laws,
information on legal transactions between Client and myapp is retained for a period of 10 years as of their provision to myapp in accordance with the general limitation period set for civil claims in the Estonian General Part of the Civil Code Act.
12. Settings
...
13. Data Transfer
We may transfer, process and store Personal Data we collect through the Services in centralized databases located in the EU. EU may not have the same data protection framework as the country from which you may be using the Services. When we transfer Personal Data to EU, we will protect it as described in this Privacy Policy.

14. Foreign Visitors
The Service is hosted in EU. If you choose to use the Service from the U.S or other regions of the world with laws governing data collection and use that may differ from EU law, then please note that you are transferring your Client Data and Personal Data outside of those regions to EU for storage and processing. Also, we may transfer your data from EU to other countries or regions in connection with storage and processing of data, fulfilling your requests, and operating the Service. By providing any information, including Client Data and Personal Data, on or to the Service, you consent to such transfer, storage, and processing.

15. Data Controller and Data Processor
myapp does not own, control or direct the use of any of the Client Data stored or processed by a Client or User via the Service. Only the Client or Users are entitled to access, retrieve and direct the use of such Client Data. myapp is largely unaware of what Client Data is actually being stored or made available by a Client or User to the Service and does not directly access such Client Data except as authorized by the Client, or as necessary to provide Services to the Client and its Users.

Because myapp does not collect or determine the use of any Personal Data contained in the Client Data and because it does not determine the purposes for which such Personal Data is collected, the means of collecting such Personal Data, or the uses of such Personal Data, myapp is not acting in the capacity of data controller in terms of the European Union’s General Data Protection Regulation (“Regulation EU 2016/679, hereinafter “GDPR”) and does not have the associated responsibilities under GDPR. myapp should be considered only as a processor on behalf of its Clients and Users as to any Client Data containing Personal Data that is subject to the requirements of GDPR. Except as provided in this Privacy Policy, myapp does not independently cause Client Data containing Personal Data stored in connection with the Services to be transferred or otherwise made available to third parties, except to third party subcontractors who may process such data on behalf of myapp in connection with myapp’s provision of Services to Clients. Such actions are performed or authorized only by the applicable Client or User.
...
myapp is not responsible for the content of the Personal Data contained in the Client Data or other information stored on its servers (or its subcontractors’ servers) at the discretion of the Client or User nor is myapp responsible for the manner in which the Client or User collects, handles disclosure, distributes or otherwise processes such information.
...
Please contact us with any questions or comments about this Policy, your Personal Data, our use and disclosure practices, or your consent choices by email at support@myappm.com.
